          ...
          {[
            {
              ...
              desc: "Master front-end and back-end skills with real-world projects.",
              image: "https://source.unsplash.com/400x250/?webdevelopment",
            },
            {
              title: "AI & Machine Learning",
              desc: "Learn the foundations of AI and build real-world ML models.",
              image: "https://source.unsplash.com/400x250/?ai,machinelearning",
            },
            {
              title: "UI/UX Design",
              desc: "Craft beautiful, user-centered designs using modern tools.",
